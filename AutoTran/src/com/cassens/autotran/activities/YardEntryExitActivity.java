...
public class YardEntryExitActivity extends VINSelectActivity
{
    private static final Logger log = LoggerFactory.getLogger(YardEntryExitActivity.class.getSimpleName());
    ...
    protected List<YardExit> yardEntryExitList;
    YardEntryExitAdapter adapter;
	...
	// Adapter for handling VINs for YardEntryExit record 
	public class YardEntryExitAdapter extends ArrayAdapter<YardExit>
	{
	    private Context context;
	    private int layoutResourceId;
	    private List<YardExit> yardEntryExitList;

	    public YardEntryExitAdapter(Context context, int textViewResourceId, List<YardExit> objects)
	    {
	        super(context, textViewResourceId, objects);
	        this.context = context;
	        this.layoutResourceId = textViewResourceId;
	        this.yardEntryExitList = objects;
	    }
	    ...
	    public View getView(final int position, View convertView, ViewGroup parent)
	    {
	        ...
	        final YardExit thisYardEntryExit = this.yardEntryExitList.get(position);
	        ...
	        vinView.setText(thisYardEntryExit.VIN);
	        ...
	        vinNumArea.setOnClickListener(new OnClickListener()
	        {
	            ...
	            {
	                ((YardEntryExitActivity)context).onVINSelected(thisYardEntryExit.VIN, false);
	            }
	    ...
	    public int getCount()
	    {
	        return this.yardEntryExitList.size();
	    }
	}
	...
	protected void drawLayout()
	{
        ...
        yardEntryExitList = DataManager.getYardExitList(this, false);
        screenTitle.setText(getResources().getString(R.string.yard_entry_exit));

        if (displayMode == DisplayMode.VIN_PICK_MODE) {
            adapter = new YardEntryExitAdapter(this, R.layout.vin_list_element, yardEntryExitList);
    ...
    private boolean vinNumberInYardEntryExitList(List<YardExit> yardEntryExitList, String vinNumber)
    {
	...
	public void onVINSelected(String vinNumber, boolean vinScanned)
	{
        ...
        {                  
            ...
            bundle.putInt("inventory_type", VINInventoryActivity.YARD_ENTRY_EXIT);
    ...
    log.debug(Logs.DEBUG, "YardEntryExitActivity: onActivityResult requestCode=" + requestCode 
